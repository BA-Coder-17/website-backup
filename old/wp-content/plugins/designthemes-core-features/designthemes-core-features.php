...
if (! class_exists ( 'DTCorePlugin' )) {
	...
	class DTCorePlugin {
		...
		function dt_widgets_init() {
			register_widget('Kalvi_Twitter');
			register_widget('Kalvi_Flickr');
			register_widget('Kalvi_Recent_Posts');
			register_widget('Kalvi_Portfolio_Widget');
		}
		...
		public static function dtCorePluginActivate() {
			if( ! function_exists('kalvi_cs_get_option') ){
