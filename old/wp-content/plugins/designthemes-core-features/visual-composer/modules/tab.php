		...
		'params' => array(
			...
			array(
				...
				'value' => array(
					...
					esc_html__('Add Image', 'designthemes-core') => 'image',
				),
				'description' => esc_html__( '"Add Image" option is applicable only if "type9" is given in "Extra class name" in main tab settings.', 'designthemes-core' ),
			),			
			...
			array(
				'type' => 'attach_image',
				'heading' => esc_html__('Add Image', 'designthemes-core'),
				'param_name' => 'image',
