    ...
    class DTSocial extends DTBaseSC {
        ...
        function dt_generate_css( $attrs ) {
            ...
            # Default State
                ...
                # BG Color
                $bg_color = '';
                if(isset($attrs['default-bg-color'])) {
                ...
                # Border Color
                $border_color = '';
                if(isset($attrs['default-border-color'])) {
            ...
            # Hover State
                ...
                # Border Color
                $border_h_color = '';
                if(isset($attrs['hover-border-color'])) {
        ...
        function dt_sc_sociable_new ( $attrs, $content = null ) {
            ...
            $out = !empty( $list ) ? "<ul id='".esc_attr( $el_id )."' class='".esc_attr( trim( $css_class ) )."'
                ...
                data-default-border-radius = '".esc_attr( isset($attrs['default-border-radius']) && $attrs['default-border-radius'] == 'true' ? 'yes' : 'no' )."'
                data-default-shape = '".esc_attr( (isset($attrs['default-shape']) && $attrs['default-shape'] != '') ? $attrs['default-shape'] : '' )."'
                data-hover-style = '".esc_attr( (isset($attrs['hover-style']) && $attrs['hover-style'] != '') ? $attrs['hover-style'] : ''  )."'
                data-hover-border-radius = '".esc_attr( isset($attrs['hover-border-radius']) && $attrs['hover-border-radius'] == 'true' ? 'yes' : 'no' )."'
                data-hover-shape = '".esc_attr( (isset($attrs['hover-shape']) && $attrs['hover-shape'] != '') ? $attrs['hover-shape'] : '' )."'
                >".$list.'</ul>' : '';
