		...
		"params" => array(
			...
			array(
				...
				'value' => array(
					...
					esc_html__('With Image','designthemes-core') => 'title-with-image',
				),
				'std' => 'two-border',
				'admin_label' => true
			),
			...
			array(
				...
				'param_name' => 'subtext',
				'value' => 'Lorem ipsum dolor',
				'dependency' => array( 'element' => 'type', 'value' => array( 'two-border-with-subtitle', 'script', 'stripe', 'type-writing', 'title-with-image' ) )
			),
			...
			array(
				...
				'dependency' => array( 'element' => 'type', 'value' => array( 'title-with-image' ) )
			),
            ...
            array(
                'type' => 'colorpicker',
                'heading' => esc_html__( 'Sub Heading Color', 'designthemes-core' ),
			...
			array(
				...
				'dependency' => array( 'element' => 'type', 'value' => array( 'decoration', 'triangle', 'title-with-image' ) )
			),
