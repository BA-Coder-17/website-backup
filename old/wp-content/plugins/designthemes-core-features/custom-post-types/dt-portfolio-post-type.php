...
if (! class_exists ( 'DTPortfolioPostType' )) {
	class DTPortfolioPostType {
		...
		function __construct() {
			...
			add_filter( 'kalvi_header_footer_default_cpt', array(
				$this,
		...
		function createPostType() {
			...
			$portslug = kalvi_cs_get_option( 'single-portfolio-slug', 'dt_portfolios' );
			$taxslug = kalvi_cs_get_option( 'portfolio-category-slug', 'portfolio_entries' );
			$tagslug = kalvi_cs_get_option( 'portfolio-tag-slug', 'portfolio_tags' );
			  ...
			  'sections'  => array(
				...
				array(
					...
					array(
					  ...
					  'options'      => array(
						'full-width-portfolio'   => KALVI_THEME_URI . '/cs-framework-override/images/portfolio-fullwidth.png',
						'with-left-portfolio'    => KALVI_THEME_URI . '/cs-framework-override/images/portfolio-with-left-gallery.png',
						'with-right-portfolio'   => KALVI_THEME_URI . '/cs-framework-override/images/portfolio-with-right-gallery.png',
					  ),
		...
		function dt_portfolio_wp_enqueue_scripts() {
			...
			wp_enqueue_style( 'kalvi-portfolio',	  plugin_dir_url ( __FILE__ ) . 'css/portfolio.css', false, KALVI_THEME_VERSION, 'all' );
