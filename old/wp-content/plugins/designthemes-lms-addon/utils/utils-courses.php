		...
		$out .= '<div class="dtlms-courses-share-holder">';
			...
			$out .= '<ul class="dtlms-courses-share-list '.esc_attr( $add_class ).'">';
						...
						if(in_array('facebook', $socialshare_items)) {
							$out .= '<li> <a href="//www.facebook.com/sharer.php?u='.$ssurl.'&amp;t='.urlencode($sstitle).'" title="facebook" target="_blank"> <span class="fa fa-facebook"></span>  </a> </li>';
						}
						...
						if(in_array('stumbleupon', $socialshare_items)) {
							$out .= '<li> <a href="//www.stumbleupon.com/submit?url='.$ssurl.'&amp;title='.urlencode($sstitle).'" title="stumbleupon" target="_blank"> <span class="fa fa-stumbleupon"></span>  </a> </li>';
						}
						if(in_array('twitter', $socialshare_items)) {
							$out .= '<li> <a href="//twitter.com/home/?status='.$ssurl.':'.urlencode($sstitle).'" title="twitter" target="_blank"> <span class="fa fa-twitter"></span>  </a> </li>';
						}
						if(in_array('googleplus', $socialshare_items)) {
							$out .= '<li> <a href="//plus.google.com/share?url='.$ssurl.'" title="googleplus" target="_blank" onclick="javascript:window.open(this.href,\"\",\"menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600\");return false;"> <span class="fa fa-google-plus"></span>  </a> </li>';
						}
						if(in_array('linkedin', $socialshare_items)) {
							$out .= '<li> <a href="//www.linkedin.com/shareArticle?mini=true&amp;title='.urlencode($sstitle).'&amp;url='.$ssurl.'" title="linkedin" target="_blank"> <span class="fa fa-linkedin"></span>  </a> </li>';
						}
						if(in_array('pinterest', $socialshare_items)) {
							$media = isset($portfolio_settings['items'][0]) ? $portfolio_settings['items'][0] : ''; 
							$out .= '<li> <a href="//pinterest.com/pin/create/button/?url='.$ssurl.'&amp;media='.$media.'" title="pinterest" target="_blank"> <span class="fa fa-pinterest"></span>  </a> </li>'; 
						}
...
// Course curriculum
function dtlms_generate_course_curriculum($user_id, $course_id, $duration_type, $preview_curriculum = false, $item_id = -1) {
...
function dtlms_check_course_curriculum_visibility($item, $course_id, $user_id, $purchased_paid_course) {
