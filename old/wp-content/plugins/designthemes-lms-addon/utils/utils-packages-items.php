		...
		if(!$purchased_package) {
			...
			if(dtlms_check_item_is_in_cart($package_id)) {
				...
				$output .= '<div class="dtlms-packagedetail-cart-details">';
					$output .= '<a href="'.esc_url(wc_get_cart_url()).'" target="_self" class="dtlms-packagedetail-cart-link dtlms-button small filled"><i class="fa fa-cart-plus"></i>'.esc_html__('View Cart','dtlms').'</a>';
				$output .= '</div>';
