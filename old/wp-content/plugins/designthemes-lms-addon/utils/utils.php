	...
	if($seconds > 0) {
		...
		if($style == 'style4') {
			...
			if($readable_format['years'] > 0) {
				$format .= $readable_format['years'].' '.esc_html__('yr', 'dtlms');
			}
			if($readable_format['months'] > 0) {
				$format .= $readable_format['months'].' '.esc_html__('mth', 'dtlms');
			}
			if($readable_format['days'] > 0) {
				$format .= $readable_format['days'].' '.esc_html__('d', 'dtlms');
			}
			if($readable_format['hours'] > 0) {
				$format .= $readable_format['hours'].' '.esc_html__('hrs', 'dtlms');
			}
			if($readable_format['minutes'] > 0) {
				$format .= $readable_format['minutes'].' '.esc_html__('mins', 'dtlms');
			}
			if($readable_format['seconds'] > 0) {
				$format .= $readable_format['seconds'].' '.esc_html__('secs', 'dtlms');
			}

		} else if($style == 'style3') {

			if($readable_format['years'] > 0) {
				$format .= $readable_format['years'].''.esc_html__('y ', 'dtlms');
			}
			if($readable_format['months'] > 0) {
				$format .= $readable_format['months'].''.esc_html__('m ', 'dtlms');
			}
			if($readable_format['days'] > 0) {
				$format .= $readable_format['days'].''.esc_html__('d ', 'dtlms');
			}
			if($readable_format['hours'] > 0) {
				$format .= $readable_format['hours'].''.esc_html__('h ', 'dtlms');
			}
			if($readable_format['minutes'] > 0) {
				$format .= $readable_format['minutes'].''.esc_html__('m ', 'dtlms');
			}
			if($readable_format['seconds'] > 0) {
				$format .= $readable_format['seconds'].''.esc_html__('s ', 'dtlms');
			}
			...
			if($readable_format['years'] > 0) {
				$format .= $readable_format['years'].' '.esc_html__('years', 'dtlms');
			}
			if($readable_format['months'] > 0) {
				$format .= $readable_format['months'].' '.esc_html__('months', 'dtlms');
			}
			if($readable_format['days'] > 0) {
				$format .= $readable_format['days'].' '.esc_html__('days', 'dtlms');
			}
			if($readable_format['hours'] > 0) {
				$format .= $readable_format['hours'].' '.esc_html__('hours', 'dtlms');
			}
			if($readable_format['minutes'] > 0) {
				$format .= $readable_format['minutes'].' '.esc_html__('minutes', 'dtlms');
			}
			if($readable_format['seconds'] > 0) {
				$format .= $readable_format['seconds'].' '.esc_html__('seconds', 'dtlms');
			}
