...
class CSFramework_Option_switcher extends CSFramework_Options {
  ...
  public function output() {
    ...
    echo '<label><input type="checkbox" name="'. $this->element_name() .'" value="1"'. $this->element_class() . $this->element_attributes() . checked( $this->element_value(), 1, false ) .'/><em data-on="'. esc_attr__( 'on', 'kalvi' ) .'" data-off="'. esc_attr__( 'off', 'kalvi' ) .'"></em><span></span></label>' . $label;
