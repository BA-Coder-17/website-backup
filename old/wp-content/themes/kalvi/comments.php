...
<div id="comments" class="comments-area">
	...
	$fields =  array(
        "author" => "<div class='column dt-sc-one-half'><p><input id='author' name='author' type='text' placeholder='".esc_html__("Name",'kalvi')."' required /></p>",
        "email"  => "<p> <input id='email' name='email' type='email' placeholder='".esc_html__("Email",'kalvi')."' required /> </p></div>",
    );

	$comment = "<div class='column dt-sc-one-half first'><textarea id='comment' name='comment' cols='5' rows='3' placeholder='".esc_html__("Comment",'kalvi')."' ></textarea></div>";
