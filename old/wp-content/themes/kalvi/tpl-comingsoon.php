...
<div class="wrapper under-construction <?php echo esc_attr($type); ?>" style="<?php echo esc_attr($style); ?>"><?php
	...
	if( !empty($pageid) ):
		...
		echo kalvi_wp_kses( $content );
	else:
		echo '<div class="uc-wrapper-inner">';
			echo '<h2>'.esc_html__('Website is almost ready', 'kalvi').'</h2>';
			echo '<p>'.esc_html__('Our website is under construction.', 'kalvi').'</p>';
			echo '<p>'.esc_html__("We'll be here soon with our new awesome.", 'kalvi').'</p>';
