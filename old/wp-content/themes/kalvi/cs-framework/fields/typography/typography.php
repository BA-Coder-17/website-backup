...
class CSFramework_Option_typography extends CSFramework_Options {
  ...
  public function output() {
    ...
    if( is_object( $google_json ) ) {
      ...
      echo '<optgroup label="'. esc_attr__( 'Web Safe Fonts', 'kalvi' ) .'">';
      ...
      echo '<optgroup label="'. esc_attr__( 'Google Fonts', 'kalvi' ) .'">';
      ...
      echo esc_html__( 'Error! Can not load json file.', 'kalvi' );
