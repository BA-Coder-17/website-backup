    ...
    <div class="dt-sc-two-fifth column">
        <div class="dt-sc-tabs-horizontal-frame-container event-meta-tab">
          <ul class="dt-sc-tabs-horizontal-frame">
            <li><a href="#" class="current"><?php esc_html_e('Details', 'kalvi'); ?></span></a></li>
            <li><a href="#"><?php esc_html_e('Organizer', 'kalvi'); ?></a></li>
            <li><a href="#"><?php esc_html_e('Venue', 'kalvi'); ?></a></li>
          </ul>
    ...
    <div class="right-calc">
        <a href="<?php echo esc_url( tribe_get_gcal_link($event_id) ); ?>"><?php esc_html_e('+ Google Calendar', 'kalvi'); ?></a>
        <span class="sep">/</span>
