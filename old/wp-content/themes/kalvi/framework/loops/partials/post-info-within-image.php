<?php
	...
	<div class="entry-thumb">
        ...
        <div class="entry-meta"><?php
            ...
            <div class="entry-info">
                <div class="author <?php echo esc_attr( $show_author_meta );?>"> <?php esc_html_e('By', 'kalvi');?> <a href="<?php echo get_author_posts_url(get_the_author_meta('ID'));?>" title="<?php esc_attr_e('View all posts by ', 'kalvi'); echo get_the_author();?>"><?php echo get_the_author();?></a></div>
    ...
    <div class="entry-details within-image">
        ...
        <div class="entry-meta-data">
			 <?php the_tags("<p class='tags {$show_tag_meta}'> <span>".esc_html__('Tags', 'kalvi')."</span> ",' ',"</p>"); ?>
        </div><!-- Category & Tag -->
