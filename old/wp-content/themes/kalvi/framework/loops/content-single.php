...
<?php # Post Author Information Box
	...
	if( !empty($post_author_box) ):?>
		...
		<section class="author-info">
        	<h2><?php esc_html_e('About Author','kalvi');?></h2>
			<div class="thumb">
	...
	if( !empty($post_navigation) ):?>
        ...
        <div class="post-nav-container">
            <div class="post-prev-link"><?php previous_post_link('%link','<i class="fa fa-angle-double-left"> </i>'.esc_html__('Prev Entry','kalvi') );?> </div>
            <div class="post-next-link"><?php next_post_link('%link',esc_html__('Next Entry','kalvi').'<i class="fa fa-angle-double-right"> </i>');?></div>
        </div><?php
	endif;
